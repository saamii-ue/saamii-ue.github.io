<?php
//send_email.php
$email_from = "no-reply@saamii.de";   //Absender falls keiner angegeben wurde
$sendermail_antwort = true;      //E-Mail Adresse des Besuchers als Absender. false= Nein ; true = Ja
$name_von_emailfeld = "Email";   //Feld in der die Absenderadresse steht
 
$empfaenger = "s.uensay@outlook.de"; //Empfänger-Adresse
$mail_cc = ""; //CC-Adresse, diese E-Mail-Adresse bekommt einer weitere Kopie
$betreff = "Kontaktformular | New"; //Betreff der Email
 
$url_ok = "#success"; //Zielseite, wenn E-Mail erfolgreich versendet wurde
$url_fehler = "#error"; //Zielseite, wenn E-Mail nicht gesendet werden konnte
